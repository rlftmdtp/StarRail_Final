...
import starrail.review.persistence.RecommendReviewDAO;

public class RecommendReviewServiceImpl implements RecommendReviewService {
	
	@Inject
	private RecommendReviewDAO dao;
