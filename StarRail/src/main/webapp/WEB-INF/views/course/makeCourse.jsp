...
<img id="myImage">
	<div id="courseWrap">
		...
		<div id="periodSetting">
			...
			<div class="input-daterange input-group" id="datepicker">
		     ...
		     <span class="fontawesome-calendar"></span>
		      <input class="input-sm form-control" type="text" id="start-date" name="start" placeholder="여행 시작일을 선택하세요"/>
		    </div>
		...
		<!-- 전체 코스 저장 버튼 영역 -->
		<div id="allSavingBtn">
			<span class="unlogin_msg">로그인을 하지 않으면 코스를 저장할 수 없습니다.&nbsp;&nbsp;</span><button type="button" class="btn btn-outline-success saveBtn" disabled>전체 코스 저장</button>
		</div>
