...
<link rel="stylesheet" type="text/css"   href="/starrail/resources/css/main/login.css?ver=1">
<link rel="stylesheet" type="text/css" href="/starrail/resources/css/main/header_footer.css?ver=1">
<script src="http://code.jquery.com/jquery-3.1.1.min.js"></script>
<!-- bootstrap에서 받아온 js파일+css파일 사용 하기 위함 -->
<script src="/starrail/resources/bootstrap/js/bootstrap.js"></script>
<script src="/starrail/resources/js/main/login/login.js"></script>
