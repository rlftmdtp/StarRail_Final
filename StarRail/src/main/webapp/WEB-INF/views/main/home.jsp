            ...
            <div class="carousel-inner" role="listbox">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="slide-text slide_style_left">
                                <h1 data-animation="animated zoomInRight">Star Rail Introduce</h1>
                                <p data-animation="animated fadeInLeft">전국 방방곡곡 일반열차를 무제한으로 이용 할 수 있는 청춘여행 지금 바로 떠나요</p>
                                <a href="http://bootstrapthemes.co/" target="_blank" class="btn btn-default" data-animation="animated fadeInLeft">플래너 시작 ></a>
                                <a href="http://bootstrapthemes.co/" target="_blank"  class="btn btn-primary" data-animation="animated fadeInRight">기차표 예약 ></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    ...
                    <div class="slide-text slide_style_center">
                        <h1 data-animation="animated flipInX">Star Rail Enjoy more</h1>
                        <p data-animation="animated lightSpeedIn">함께할 동행자도 찾고 여행 경비도 관리하고 일석 이조!</p>
                        <a href="http://bootstrapthemes.co/" target="_blank" class="btn btn-default" data-animation="animated fadeInUp">여행 경비 플래너 ></a>
                        <a href="http://bootstrapthemes.co/" target="_blank"  class="btn btn-primary" data-animation="animated fadeInDown">동행자 찾기 ></a>
                    </div>
                </div>
                <!-- End of Slide -->
                ...
                <div class="item">
                    ...
                    <div class="slide-text slide_style_right">
                        <h1 data-animation="animated zoomInLeft">Share</h1>
                        <p data-animation="animated fadeInRight">나의 플래너 공유 / 여행 후기 / 여행 추천을 통한 다양한 서비스 제공</p>
                        </div>
                </div>
                <!-- End of Slide -->
